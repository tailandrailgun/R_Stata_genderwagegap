...
** Education **
gen grade0to8=(educ90==0)
gen somehighschool=(educ90==1)
gen highschoolgrad=(educ90==2)
gen somepostsecondary=(educ90==3)
gen postsecondarygrad=(educ90==4)
gen bachdegree=(educ90==5)
gen abovebach=(educ90==6)
...
oaxaca lnwage age_12 marstat educ90 ftptmain city_size, by(sex) pooled svy